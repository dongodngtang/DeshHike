...
const navBarHeight = Platform.OS === "ios" ? height > 800 ? 88 : 64 : 44;
const toolMargin = Platform.OS === "ios" ? height > 800 ? 44 : 20 : 0;
const iPhone_X = Platform.OS === "ios" &&  screenHeight > 800;
